...
I am a Computer Science student at Frankfurt University of Applied Sciences with hands-on experience in designing and developing web and Android applications and data-driven systems.
...
Design and development of a web and Android application for digital attendance, prayer, and event management using a shared React Native and Expo codebase.
...
Creation of a TradingView indicator through an AI-assisted development process. The project translates trading concepts and systematic market analysis into clearly defined and testable rules.

- Translated trading concepts and chart examples into precise functional requirements
- Guided the iterative implementation in Pine Script using AI-assisted workflows
- Tested and validated generated signals against historical market data
- Identified false signals, edge cases, and inconsistencies to refine the underlying logic
- Specified alert behavior, entry conditions, stop-loss and take-profit logic
- Evaluated results using trade and win-rate statistics

## Technical Skills

- **Programming:** Java, C++, C
- **Web & Mobile:** React Native, Expo
- **Data & Backend:** Firebase, Firestore, MongoDB, Apache Spark
